...
import static com.example.gruppprojektet_musicapp.ui.ConcertInfo.ConcertInfoFragment.setupDB;

public class Database extends SQLiteOpenHelper {

    //http://www.androidtutorialshub.com/android-login-and-register-with-sqlite-database-tutorial/ was used as help with the database and functions
    //Init database
    ...
    //My shows, relation table for users and shows
    ...
    */
    ...
    public boolean addData()
    {
        ...
        ///////////////////////////CONCERT//////////////////////////////////////////////////////
        //testdata
        contentValues.put(COLUMN_CONCERT_NAME, "Inflames At Örthagsparken");
        ...
        //testdata
        contentValues.put(COLUMN_CONCERT_NAME, "Tjo At Stadsparken");
        ...
        contentValues.put(COLUMN_CONCERT_NAME, "Red Hot Chili Peppers At Backstage Rockbar");
        ...
        Cursor  cursor =  setupDB.rawQuery("select * from " +  TABLE_CONCERT  +  " where " + COLUMN_CONCERT_NAME  + "=?", new String[] {entry});
        ...
        cursor = setupDB.rawQuery("select * from " +  TABLE_CONCERT  +  " where " + COLUMN_CONCERT_NAME  + "=?", new String[] {"Tjo"});
        if (cursor != null) {
            cursor.moveToFirst();
            concertID = cursor.getString(0);
        }
        ...
        cursor = setupDB.rawQuery("select * from " +  TABLE_CONCERT  +  " where " + COLUMN_CONCERT_NAME  + "=?", new String[] {"Red Hot Chili Peppers"});
        if (cursor != null) {
            cursor.moveToFirst();
            concertID = cursor.getString(0);
        }
